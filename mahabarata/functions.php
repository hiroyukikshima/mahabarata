...
wp_enqueue_style('my', get_template_directory_uri() . '/Mahabarata/css/style.css', array(), '1.0.0', 'all');
wp_enqueue_script('my', get_template_directory_uri() . '/Mahabarata/js/script.js', array( 'jquery' ), '1.0.0', true);
}
add_action('wp_enqueue_scripts', 'my_script_init');

/* css & js 読み込み */
function my_scripts() {
  wp_enqueue_style( 'my-animate-style', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.4.0/animate.min.css', array(), '3.4.0' );
