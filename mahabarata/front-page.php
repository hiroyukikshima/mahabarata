<?php get_header(); ?>
      ...
      <div class="top-container-body">
        ...
        <div class="top-container-body-right">
          <p class="top-container-right-text">
            小池博史ブリッジプロジェクトが2013年から2020年までの8カ年計画で臨む、インド古代叙事詩「マハーバーラタ」の全編舞台作品化計画。いよいよその集大成である<span class="top-container-right-text-bold">完全版マハーバーラタ</span>の公演が決定！！<br>アジア各国のアーティストらが共同で取り組み、発展を遂げる本事業はアジア、そして世界へ向けてビッグウェーブを起こす。タイと日本から世界へと発信する本作。どうぞお見逃しなく！
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="introduction">
    ...
    <div class="iframe-wrap wow fadeIn">
    ...
    <div class="inner">
      ...
      <div class="comments-container">
        <div class="comments-container-head">
          <p class="comments-container-head-title">京都佛立ミュージアム館長<br class="is-sp"><span class="comments-container-head-title-text-margin">長松清潤</span></p>
        </div>
